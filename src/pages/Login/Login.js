...
import { LoginAction } from '../../redux/Actions/ManageAccountActions';
                ...
                <div className='col-start-5 col-span-4'>
                    <div className='border p-4 rounded-md shadow-lg'>
                        ...
                        <form onSubmit={formik.handleSubmit}>
                            ...
                            <button type="submit" className="text-white bg-green-300 hover:bg-green-300 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-lg w-full lg:w-auto px-5 py-2.5 text-center dark:bg-green-400 dark:hover:bg-green-500 dark:focus:ring-green-500">Đăng nhập</button>
                            <div className='mt-4'>
                                Bạn chưa có tài khoản? <NavLink to={_register} className='font-medium text-black hover:text-green-400 hover:underline'>Đăng ký ngay</NavLink>
                            </div>
                        </form>
                    </div>
                </div>
