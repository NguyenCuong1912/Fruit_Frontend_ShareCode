...
import { ManageCartReducers } from './../../../redux/Reducers/ManageCartReducers';
import { IMG } from '../../../utils/Settings/config';
import { DELETE_CART, UPDATE_CART } from '../../../redux/Types/ManageCartTypes';
import { AiOutlineMinus, AiOutlinePlus } from 'react-icons/ai';
import { CheckoutAction } from '../../../redux/Actions/ManageCheckoutActions';
        ...
        <Fragment>
            <div className='grid grid-cols-5 my-48'>
                <div className='col-start-2 col-span-3'>
                    <div className='py-8 border-b-2 uppercase text-center text-3xl text-green-500 font-bold'>Giỏ hàng</div>
                    <div className='mt-4'>
                        ...
                        <div className='grid grid-cols-12 pt-6'>
                            ...
                            <div className='col-span-4 text-end'>
                                ...
                                <div>
                                    ...
                                    }} className='border bg-green-500 text-white py-2 px-4 font-medium rounded hover:bg-green-700'>Thanh toán</button>
                                </div>
                            </div>
                        </div>
                    </div>
