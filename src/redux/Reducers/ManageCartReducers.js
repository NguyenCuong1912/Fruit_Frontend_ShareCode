import { ADD_CART, CLEAR_CART, DELETE_CART, GET_BILL_DETAIL, GET_CHECKOUT_HISTORY, GET_LIST_BILL, UPDATE_CART } from "../Types/ManageCartTypes"
...
export const ManageCartReducers = (state = initialState, { type, data }) => {
    switch (type) {
